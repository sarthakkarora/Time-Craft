...
let ringtone = new Audio("ipl_stadium.mp3");
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const dateYearElem = document.getElementById('dateYear');
    const currentDate = new Date();
    const options = { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' };
    dateYearElem.innerText = currentDate.toLocaleDateString('en-US', options);
});
